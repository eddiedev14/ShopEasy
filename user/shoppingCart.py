...
try:
    ...
    imagePath_1 = product["Imagen"]
    title_1 = product["Nombre"]
    quantity_1 = product["Cantidad"]
    description_1 = product["Descripcion"]
    price_1 = product["Subtotal"]
    ...
    createCounter(quantity_1, 432.0, 211.0)
    createPrice(price_1, 499.0, 211.0)
